...
![Amplify Console page displaying a toggle button to enable the previews functionality](/images/gen2/fullstack-branching/previews-4.png)
...
![GitHub pull request displaying ](/images/gen2/fullstack-branching/previews-5.png)
